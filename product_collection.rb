#ЗАДАЧА
# реализуйте класс ProductCollection, который может хранить в себе любые товары (фильмы или книги) и у которого есть:
...
class ProductCollection
  ...
  def sort!(params)
    ...
    case params[:by] # Делает выбор по параметру by
    when :title
